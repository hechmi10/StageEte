            ...
            <div class="col-md-6">
                <form action="{{ route('Tache3') }}" method="post">
                    ...
                    <fieldset class="border p-4">
                        <legend class="w-auto px-2">Suppression du tache</legend>
                        <div class="form-group">
                            <label>Nom du tache à supprimer</label><br>
                            <input type="text" class="form-control" name="nomtache" placeholder="Nom du tache" required><br>
                        </div>
                        <button type="submit" class="btn btn-primary">Supprimer le tache<br>
                    </fieldset>
                </form>
            </div>
        </div>
