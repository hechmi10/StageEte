            ...
            <div class="col-md-6">
                <form action="{{ route('Projet') }}" method="post">
                    ...
                    <fieldset class="border p-4">
                        <legend class="w-auto px-2">Gestion des projets</legend>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nomprojet" placeholder="Nom du projet"
                                required><br>
                        </div>
                        <div class="form-group">
                        <label>Date du début</label><br>
                        <input type="date" class="form-control" name="datedebut" placeholder="Date du début" required><br>
                        </div>
                        <div class="form-group">
                        <label>Date du fin</label><br>
                        <input type="date" class="form-control" name="datefin" placeholder="Date du fin" required><br>
                        </div>
