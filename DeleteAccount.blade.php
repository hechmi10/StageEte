            ...
            <div class="col-md-6">
                <form action="{{ route('Delete') }}" method="POST">
                    ...
                    <fieldset class="border p-4">
                        <legend class="w-auto px-2">Supprimer le compte</legend>
                        <div class="form-group">
                            <label>Cin</label><br>
                            <input type="text" class="form-control" name="cin" placeholder="Votre CIN" required><br>
                        </div>
                        <div class="form-group">
                            <label>Email</label><br>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Votre email" required><br>
                        </div>
                        <button type="submit" class="btn btn-primary">Supprimer</button><br>
                    </fieldset>
                </form>
            </div>
        </div>
