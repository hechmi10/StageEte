        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <fieldset class="border p-4">
                    <legend class="w-auto px-2">Mise à jour du projet</legend>
                    <form action="{{route('Projet2')}}" method="post">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="id">Identification du projet</label>
                        <input type="text" class="form-control" id="id" name="id" placeholder="Identification du projet" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="debut">Nouveau Date du début</label>
                        <input type="date" class="form-control" id="debut" name="debut" placeholder="Date du début" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="fin">Nouveau Date du fin</label>
                        <input type="date" class="form-control" id="fin" name="fin" placeholder="Date du fin" required>
                    </div>
                    <button type="submit" class="btn btn-primary w-100">Terminer</button>
                </form>
                </fieldset>
            </div>
        </div>
