                                ...
                                <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6 mb-4 mb-lg-0">
                                            <img src="{{asset('images/hechmi.jpg')}}" alt="...">
                                        </div>
                                        <div class="col-lg-6 px-xl-10">
                                            <div class="bg-secondary d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-1-9 rounded">
                                                <center><h3 class="h2 text-white mb-0">Admin</h3></center>
                                                <h3 class="h2 text-white mb-0">{{ $admin->nom }} {{ $admin->prenom }}</h3>
                                            ...
                                            <ul class="list-unstyled mb-1-9">
                                                ...
                                                <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Téléphone:</span> {{ $admin->numTel }}</li>
                                            </ul>
