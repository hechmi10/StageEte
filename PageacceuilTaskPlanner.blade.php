    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="container text-center mt-5">
                <h1>TaskPlanner</h1>
                <div class="mt-4">
                    <img src="..\images\lists-6131213_1280.jpg" height="500cm" width="700cm">
                    <p>TaskPlanner est une application plateforme qui permet aux employés de compléter leurs taches de
                        leur projet planifié par leur admin</p>
                </div>
            </div>
