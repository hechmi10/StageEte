                ...
                <div class="col-md-6">
                    <form action="{{ route('Tache') }}" method="post">
                        ...
                        <fieldset class="border p-4">
                            <legend class="w-auto px-2">Gestion des taches</legend>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="periode" placeholder="Période du tache"
                                    required><br>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="projectid"
                                    placeholder="Identifiant du projet" required><br>
                            </div>
