            ...
            <div class="col-md-6">
                <form action="{{ route('Projet3') }}" method="post">
                    ...
                    <fieldset class="border p-4">
                        <legend class="w-auto px-2">Suppression du projet</legend>
                        <div class="form-group">
                            <label>Identité du projet</label><br>
                            <input type="text" class="form-control" id="id" name="id" placeholder="Identification du projet" required><br>
                        </div>
                        <button type="submit" class="btn btn-primary">Supprimer<br></button>
                    </fieldset>
                </form>
            </div>
        </div>
